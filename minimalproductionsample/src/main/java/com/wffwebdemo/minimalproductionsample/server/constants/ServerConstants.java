...
public class ServerConstants {
	...
	static {
		...
		LOCAL_MACHINE_PORT = webPort != null && !webPort.isEmpty() ? webPort : "8080";
		...
		ORIGIN_DOMAIN_URL = originDomainUrlFromEnv != null ? originDomainUrlFromEnv
				: "http://" + LOCAL_MACHINE_IP + ":" + LOCAL_MACHINE_PORT;
		
		SESSION_TIMEOUT = sessionTimeoutFromEnv != null ? Integer.parseInt(sessionTimeoutFromEnv) : 5;
